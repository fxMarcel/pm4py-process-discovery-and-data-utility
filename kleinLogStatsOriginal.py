...
def main():
    ...
    anonymized_log_path = os.path.join(metrics_dir, "20250414_klein_event_log.xes")
    ...
    # JSON speichern
    json_path = os.path.join(metrics_dir, "benchmarking_results_klein.json")
    with open(json_path, "w") as f:
        json.dump(all_results, f, indent=4)

    # Plot speichern
    plot_path = os.path.join(metrics_dir, "benchmarking_plot_klein.png")
